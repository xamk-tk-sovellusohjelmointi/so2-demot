...
> [!WARNING] **Prisma v7 asennusohjeet** löytyvät [prisma7_asennus.md](./prisma7_asennus.md) -tiedostosta. Siellä on muutama huomio Prisman käyttöön demoissa, joka kannattaa huomioida.

# Demo 3: REST-rajapinnan testaus Postmanilla
...
> **Huom:** Demo 3 tallentaa ajot palvelimen muistissa olevaan taulukkoon. Tiedot häviävät, kun palvelin käynnistetään uudelleen.
...
|--------|------|
| Metodi | GET |
| URL | `http://localhost:3003/api/ajopaivakirja` |
| Body | — (ei tarvita) |
...
|--------|------|
| Metodi | GET |
| URL | `http://localhost:3003/api/ajopaivakirja/1` |
| Body | — (ei tarvita) |
